...
namespace Library.Migrations
{
    ...
    [Migration("20210324171430_bookToCopies")]
    partial class bookToCopies
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Library.Models.Patron", b =>
                {
                    ...
                    b.Property<string>("PatronUserId")
                        .HasColumnType("varchar(255) CHARACTER SET utf8mb4");

                    b.HasKey("PatronId");

                    b.HasIndex("PatronUserId");
            ...
            modelBuilder.Entity("Library.Models.Patron", b =>
                {
                    b.HasOne("Library.Models.ApplicationUser", "PatronUser")
                        .WithMany()
                        .HasForeignKey("PatronUserId");

                    b.Navigation("PatronUser");
                });
